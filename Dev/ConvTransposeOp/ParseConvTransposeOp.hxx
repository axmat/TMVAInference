...
ParserFuncSignature ParseConvTransposeOp = [](RModelParser_ONNX &model,
   ...
   case ETensorType::FLOAT:
      op.reset(new ConvTransposeOp<float>(autoPad, dilations, group, kernelShape, outputPadding, outputShape,
