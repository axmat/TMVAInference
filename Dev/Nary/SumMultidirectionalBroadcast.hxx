...
namespace TMVA_SOFIE_SumMultidirectionalBroadcast{
struct Session {
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "SumMultidirectionalBroadcast.dat";
}
...
} //TMVA_SOFIE_SumMultidirectionalBroadcast

#endif  // TMVA_SOFIE_SUMMULTIDIRECTIONALBROADCAST
